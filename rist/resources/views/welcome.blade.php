                ...
                <div class="col-lg-8 col-xl-7 fade-up">
                    <div class="card border-0 shadow-lg rounded-4 overflow-hidden bg-white">
                        <div class="card-body p-4 p-md-5">
                            ...
                            @php
                                $reservationsBlocked = \Illuminate\Support\Facades\Cache::get('reservations_blocked', false);
                            @endphp
                            ...
                            @if($reservationsBlocked)
                                <div class="text-center py-4">
                                    ...
                                    <h3 class="fw-bold text-dark mb-3">Siamo spiacenti</h3>
                                    <p class="text-muted fs-5 mb-0">Il ristorante è quasi al completo e non possiamo accettare ulteriori prenotazioni online al momento.</p>
                                    <p class="text-muted fs-5 mt-2">Per maggiori info e per verificare eventuali disponibilità last-minute, chiamaci al <strong>+39 06 1234567</strong>.</p>
                                </div>
                            @else
