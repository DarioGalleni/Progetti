        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
            <ul class="navbar-nav gap-2 gap-lg-3 text-center mt-3 mt-lg-0 align-items-center">
                ...
                <li class="nav-item ms-lg-2">
                    <button type="button"
                        class="btn btn-outline-light rounded-pill px-3 py-1 d-flex align-items-center justify-content-center gap-2 mx-auto"
                ...
                <li class="nav-item ms-lg-2 mt-2 mt-lg-0">
                    <a href="{{ route('dashboard') }}"
                        class="btn btn-warning text-dark fw-bold rounded-pill px-3 py-1 d-flex align-items-center justify-content-center gap-2 shadow-sm mx-auto"
