                ...
                <div class="card beach-card">
                    <div class="card-header bg-white border-bottom-0 pt-4 pb-0">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <span class="badge bg-primary fs-6">
                                Ombrellone {{ strtoupper($prenotazione->ombrellone->fila) }} -
                                {{ $prenotazione->ombrellone->numero }}
                            </span>
                        </div>
                    </div>
                    ...
                    <div class="card-body p-4">
                        <div class="row g-4">
                            ...
                            <div class="col-md-6">
                                ...
                                @if($prenotazione->telefono)
                                    <p class="mb-1">
                                        ...
                                        <a href="https://wa.me/{{ preg_replace('/[^0-9]/', '', $prenotazione->telefono) }}"
                                            target="_blank">Invia Messaggio</a>
                                    </p>
                                @endif
                            </div>
                            ...
                            {{-- Sezione Soggiorno --}}
                            <div class="col-md-6">
                                <h5 class="text-secondary border-bottom pb-2 mb-3">Dettagli Permanenza</h5>
