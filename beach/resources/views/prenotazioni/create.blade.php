                    ...
                    <form action="{{ route('prenotazioni.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('ombrellone_id') is-invalid @enderror" 
                                    ...
                                    name="ombrellone_id" 
                                    required>
                                <option value="" disabled {{ !isset($ombrellone) && !old('ombrellone_id') ? 'selected' : '' }}>Seleziona un ombrellone</option>
                                @foreach($ombrelloni as $o)
                                    <option value="{{ $o->id }}" 
                                            {{ (isset($ombrellone) && $ombrellone->id == $o->id) || old('ombrellone_id') == $o->id ? 'selected' : '' }}>
                                        {{ $o->getIdentificativoAttribute() }}
                                    </option>
                                @endforeach
                            </select>
                            @error('ombrellone_id')
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="arrivo" class="form-label">Data di Arrivo <span class="text-danger">*</span></label>
                                <input type="date" 
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="partenza" class="form-label">Data di Partenza <span class="text-danger">*</span></label>
                                <input type="date" 
                        ...
                        <p class="text-muted small mb-3">
                            *Nota: La data di **Partenza** è il primo giorno in cui l'ombrellone sarà libero. L'ombrellone risulterà occupato fino al giorno precedente.
                            (Esempio: Arrivo 13 Nov, Partenza 17 Nov &rarr; Occupato dal 13 Nov al 16 Nov inclusi).
                        </p>
                        ...
                        <div class="alert alert-info">
                            <small><i class="bi bi-info-circle"></i> I campi contrassegnati con <span class="text-danger">*</span> sono obbligatori</small>
                        </div>
