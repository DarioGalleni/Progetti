<x-layout :title="'Partenze - ' . $date->format('d/m/Y')">
    <div class="row mb-4 no-print align-items-center">
        <!-- Navigazione Data -->
        <div class="col-md-6 d-flex gap-2 align-items-center">
            <form action="{{ route('departures.index') }}" method="GET" class="d-flex gap-2 align-items-center">
    ...
    <div class="text-center mb-3">
        <h1>Partenze - {{ $date->format('d/m/Y') }}</h1>
    </div>
