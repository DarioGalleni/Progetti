        ...
        <div class="row mb-4">
            <div class="col">
                ...
                <p class="text-muted d-md-none small mb-0">
                    <i class="bi bi-info-circle me-1"></i>Clicca sul numero di telefono per chiamare, sul link Whatsapp per
                    chattare o sull'email per scrivere.
                </p>
                                ...
                                @foreach($customers as $customer)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @endif
                                            @if($customer->email)
                                                <div class="small mt-1"><a href="mailto:{{ $customer->email }}"
                                                        class="text-decoration-none"><i class="bi bi-envelope me-1"></i>
