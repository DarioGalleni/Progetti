                ...
                <div class="card-body">
                    <form action="{{ route('customers.update', $customer) }}" method="POST">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" step="0.01"
                                        ...
                                        name="total_price" value="{{ old('total_price', $customer->total_price) }}">
                                </div>
                        ...
                        <div class="d-grid gap-2">
                            <button type="submit" class="btn btn-warning btn-lg">Aggiorna Prenotazione</button>
                            <a href="{{ route('customers.show', $customer) }}" class="btn btn-light">Annulla</a>
                        </div>
                    </form>
                </div>
            </div>
