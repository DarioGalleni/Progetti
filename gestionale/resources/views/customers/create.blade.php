    ...
    <div class="container mt-5">
        ...
        <form action="{{ route('customers.store') }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="number" step="0.01" class="form-control @error('total_stay_cost') is-invalid @enderror" id="total_stay_cost" name="total_stay_cost"
            ...
            <div class="mb-3">
                ...
                <input type="number" step="0.01" class="form-control @error('down_payment') is-invalid @enderror" id="down_payment" name="down_payment"
