        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0 align-items-center">
                ...
                <li class="nav-item ms-2">
                    <a class="btn btn-primary rounded-pill px-4 fs-6 fw-bold shadow-sm {{ Request::routeIs(['journeys.table', 'journeys.create', 'journeys.edit']) ? 'active' : '' }}"
                        href="{{ route('journeys.table') }}">
