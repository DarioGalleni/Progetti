    ...
    <div class="container text-md-left">
        <div class="row text-md-left">
            ...
            <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mt-3">
                ...
                <p><a href="{{ route('journeys.index') }}" class="text-white-50 text-decoration-none hover-primary">I
                        Nostri Viaggi</a></p>
        ...
        <div class="row align-items-center">
            <div class="col-md-7 col-lg-8">
                <p class="text-white-50">
                    ...
                    <a href="https://www.dariux87.it" class="text-primary text-decoration-none fw-bold"
                        target="_blank">Dario</a>
                </p>
            </div>
